            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 intro-text">
                        <h1>Строительство дома
                            И ремоделирование</h1>
                        <div id="header_div">
                            <p id="header_paragraph"></p>
                        </div>
                        <a href="#about" class="btn btn-custom btn-lg page-scroll">Подробно</a></div>
                </div>
            </div>
        </div>
    </div>
...
<div id="about">
    <div class="container">
        <div class="row">
            <div id="about_picture" class="col-xs-12 col-md-6">
                <img src="../backend/img/about/about/1.jpg" class="img-responsive" alt="image">
            </div>
            <div class="col-xs-12 col-md-6">
                <div class="about-text">
                    <h2>Кто мы</h2>

                    <p id="about_paragraph"></p>
                    <h3>Почему выбирать нас?</h3>
...
<script type="text/javascript" src="../backend/js/about.js"></script>
